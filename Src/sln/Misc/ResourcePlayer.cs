...
namespace TypingWpf
{
  public class ResourcePlayer
  {
    ...
    public void PlayAudioQue() { _soundPlayer.Stream = Properties.Resources.AudioQue; _soundPlayer.Play(); }
    ...
    public void PlayByeByeSound()
    {
      switch (_rnd.Next(6))
      {
        ...
        case 5: _soundPlayer.Stream = Properties.Resources.Bye___I_ll_be_back; break;
          //cas6e 0: //obnoxious:        _soundPlayer.Stream = Properties.Resources.Bad___B_B_suxx2; break;
          //cas7e 1: //very disturbing:  _soundPlayer.Stream = Properties.Resources.Bad___Cry; break;
          //cas8e 2: //obnoxious:        _soundPlayer.Stream = Properties.Resources.Bad___Noseblow; break;
          //case 5: //obnoxious:        _soundPlayer.Stream = Properties.Resources.Bye___Apple; break;
      }
