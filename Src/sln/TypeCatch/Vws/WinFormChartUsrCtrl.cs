...
namespace TypingWpf.Vws
{
  public partial class WinFormChartUsrCtrl : UserControl
  {
    ...
    public ObservableCollection<SessionResult> LoadDataToChart_Prop { get => _Srl; set { _Srl = value; DrawChart(value); } }
    ...
    public void DrawChart(IEnumerable<SessionResult> lst)
    {
      try
      {
        ...
        foreach (var sr in lst) { s.Points.AddXY(sr.DoneAt.DateTime, sr.CpM); }
    ...
    public Chart Chartuc { get => chart1; set => chart1 = value; }
