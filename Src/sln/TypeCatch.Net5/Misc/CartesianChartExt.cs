...
public static class CartesianChartExt
{
  public static void LoadDataToChart(this CartesianChart cc, IEnumerable<SessionResult> sr)
  {
    try
    {
      ...
      cc.Series = new SeriesCollection(dayConfig) { new LineSeries { Values = new ChartValues<DateMdl>(), PointGeometry = DefaultGeometries.Circle, PointGeometrySize = 4, PointForeground = System.Windows.Media.Brushes.Yellow, LineSmoothness = .01 } };
